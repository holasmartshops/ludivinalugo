...
const Footer = () => {
  return (
    <footer className="bg-dark border-t border-dark-border py-16">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="font-cormorant text-cream/50 mt-4 leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Lectura de Ángeles", "Guías Espirituales", "Amuletos Sagrados"].map((item) => (
                <li key={item}>
                  <a href="#servicios" className="font-cormorant text-cream/50 hover:text-gold transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Aviso de Privacidad", "Términos y Condiciones", "Política de Cookies"].map((item) => (
                <li key={item}>
                  <a href="#" className="font-cormorant text-cream/50 hover:text-gold transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="font-cormorant text-cream/50 mb-3">
            ...
            >
              <input
                type="email"
                placeholder="Email"
                className="flex-1 bg-dark-card border border-dark-border text-cream placeholder:text-cream/30 px-3 py-2 text-sm font-cormorant focus:outline-none focus:border-gold/60 transition-colors"
              />
              <button
                type="submit"
        ...
        <div className="mt-12 pt-8 border-t border-dark-border text-center">
          <p className="font-cormorant text-xs text-cream/30">
