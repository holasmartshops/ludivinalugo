      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="font-inter text-cream/50 mt-4 leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Lectura de Ángeles", "Guías Espirituales", "Amuletos Sagrados"].map((item) => (
                <li key={item}>
                  <a href="#servicios" className="font-inter text-cream/50 hover:text-gold transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Aviso de Privacidad", "Términos y Condiciones", "Política de Cookies"].map((item) => (
                <li key={item}>
                  <a href="#" className="font-inter text-cream/50 hover:text-gold transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="font-inter text-cream/50 mb-3">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex">
              <input
                type="email"
                placeholder="Email"
                className="flex-1 bg-dark-card text-cream placeholder:text-cream/30 px-3 py-2 text-sm font-inter focus:outline-none focus:ring-1 focus:ring-gold/40 transition-colors"
              />
              <button
                type="submit"
