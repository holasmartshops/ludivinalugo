    ...
    <section className="bg-dark py-24">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center max-w-4xl mx-auto">
          {stats.map((stat) => (
            <div key={stat.label}>
              <p className="font-cinzel text-4xl md:text-5xl text-gold tracking-wider mb-2 gold-glow">
                {stat.number}
              </p>
              <p className="font-cinzel text-xs tracking-[0.2em] uppercase text-cream/60">
                {stat.label}
              </p>
            </div>
          ))}
