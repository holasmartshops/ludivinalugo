...
const HeroSection = forwardRef<HTMLElement>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      {/* Bottom fade to dark */}
      <div className="absolute bottom-0 left-0 right-0 h-96 z-20" style={{ background: "linear-gradient(to bottom, transparent 0%, rgba(10,10,10,0.15) 25%, rgba(10,10,10,0.4) 50%, rgba(10,10,10,0.7) 75%, #0a0a0a 100%)" }} />
