      ...
      <div className=" container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-8 items-center min-h-screen pt-24 pb-0">
        ...
        <div className=" relative z-10 text-center lg:text-left animate-fade-in-up self-center">
          <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
            ...
            <span className="font-cinzel font-bold text-sm md:text-base tracking-[0.3em] uppercase text-foreground/70">
          ...
          <p className="font-cinzel font-bold text-base md:text-lg tracking-[0.2em] uppercase text-gold-dark mb-8">
