    ...
    <section id="tienda" className="bg-dark py-24">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-cormorant text-cream/60 max-w-md mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
          {intentions.map((item) => (
            ...
            >
              <div className="w-20 h-20 rounded-full border border-gold/30 bg-dark-card flex items-center justify-center mb-4 group-hover:border-gold group-hover:bg-gold/5 transition-all duration-300">
